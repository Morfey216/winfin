(function () {
  ...
  var mainSlider = (function () {
    var container = document.querySelector('.main-slider__container');
    if (!container) return;
    var wrapper = container.querySelector('.main-slider__wrapper');
    var slides = container.querySelectorAll('.main-slider__slide');
  ...
  var examples = (function () {
    ...
    if (!examples) return;
    var container = examples.querySelector('.examples__gallery-top');
    var wrapper = container.querySelector('.examples__wrapper');
    var slides = container.querySelectorAll('.examples__slide');
    var thumbs = examples.querySelector('.examples__gallery-thumbs');
    var thumbsWrapper = thumbs.querySelector('.thumbs__wrapper');
    var thumbsSlides = thumbs.querySelectorAll('.thumbs__slide');
    ...
    function sliderInit() {
      ...
      var galleryTop = new Swiper(container, {
        preloadImages: true,
        loadPrevNext: true,
        loadPrevNextAmount: 2,
        spaceBetween: 10,
  ...
  var popularDoors = (function () {
    var container = document.querySelector('.popular-doors');
    if (!container) return;
    var contents = container.querySelectorAll('.popular-doors__models-set');
    var controls = container.querySelectorAll('.js-pdc-button');
    var activeClass = 'active';
    var disabledClass = 'disabled';
    var activeControl;
  ...
  var map = (function () {
    ...
    var addressPoints = [[55.859069, 37.602726, '<div><span class="img"><img src="img/logos/logo-footer.png" width="300" height="150"></span><br><h3>Наш офис:</h3><br>г. Москва, Отрадная, 2<br>ежедневно с 10:00 - 20:00<br><hr>e-mail: window@winfin.ru<br><b>+7 (499) 904 14 88  +7(499) 904 01 71</b><br>Viber / WhatsApp +79169495077</div>', 'Офис компании WINFIN']];
    var tiles = L.tileLayer('http://{s}.tile.osm.org/{z}/{x}/{y}.png', {
      maxZoom: 18,
      attribution: 'Map data &copy; <a href="https://www.openstreetmap.org/">OpenStreetMap</a> contributors, <a href="https://creativecommons.org/licenses/by-sa/2.0/">CC-BY-SA</a>, Imagery © <a href="https://www.mapbox.com/">Mapbox</a>'
    });
    var latlng = L.latLng(55.859069, 37.602726);
    var map = L.map('map', {
      center: latlng,
      zoom: 14,
      layers: [tiles]
  ...
  var certificates = (function () {
    ...
    var container = certificates.querySelector('.certificates__container');
    var wrapper = container.querySelector('.certificates__wrapper');
    var slides = container.querySelectorAll('.certificates__slide');
  ...
  var calculatorForm = (function () {
    var form = document.querySelector('.js-cf');
    if (!form) return;
    var sizeInput = form.querySelectorAll('.js-cf-size input');
    ...
    sizeInput.forEach(function (current) {
  ...
  /* global Cleave */
  var orderMeasurerForm = (function () {
    var form = document.querySelector('.js-omf');
    if (!form) return;
    var phoneInput = document.querySelector('.js-omf-phone input');
    var button = document.querySelector('.js-omf-submit');
    var parsleyForm;
    var parsleyOptions = {
      uiEnabled: false,
      focus: 'none'
  ...
  /* global Swiper */
  var multiExamples = (function () {
    var mainBlock = document.querySelector('.multi-examples');
    if (!mainBlock) return;
    var contents = mainBlock.querySelectorAll('.multi-examples__set');
    var controls = mainBlock.querySelectorAll('.js-mec-control-button');
    var activeClass = 'active';
    var disabledClass = 'disabled';
    var activeControl;
    var galleryThumbs;
  ...
  var feedbackForm = (function () {
    var form = document.querySelector('.js-fbf');
    if (!form) return;
    var phoneInput = document.querySelector('.js-fbf-phone input');
    var nameInput = document.querySelector('.js-fbf-name input');
    var button = document.querySelector('.js-fbf-submit');
    var parsleyForm;
    var parsleyOptions = {
      uiEnabled: false,
      focus: 'none'
  ...
  var accessories = (function () {
    ...
    var container = accessories.querySelector('.accessories__container');
    var wrapper = container.querySelector('.accessories__wrapper');
    var slides = container.querySelectorAll('.accessories__slide');
  ...
  var productDescription = (function () {
    function initFormValidation() {
      var form = document.querySelector('.js-pdcrf');
      if (!form) return;
      var phoneInput = form.querySelector('.js-pdcrf-phone input');
      var button = form.querySelector('.js-pdcrf-submit');
      var parsleyForm;
      var parsleyOptions = {
        uiEnabled: false,
        focus: 'none'
    ...
    function initSlider() {
      var productDescriptionVisual = document.querySelector('.product-description__visual');
      if (!productDescriptionVisual) return;
      var container = productDescriptionVisual.querySelector('.product-description__gallery-container');
      var wrapper = container.querySelector('.product-description__gallery-wrapper');
      var slides = container.querySelectorAll('.product-description__image-wrapper');
      var thumbs = productDescriptionVisual.querySelector('.product-description__slider-gallery-thumbs');
      var thumbsWrapper = thumbs.querySelector('.product-description__thumbs-wrapper');
      var thumbsSlides = thumbs.querySelectorAll('.product-description__thumbs-slide');
